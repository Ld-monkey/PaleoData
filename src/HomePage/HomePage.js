  ...
  return (
    <div className="home-page">
      <section className="about-section">
        <h2>À Propos</h2>
        <p>
          PaleoData est votre source ultime d'informations sur la paléontologie,
          offrant des données sur les créatures étonnantes du Paléozoïque
          jusqu'à nos jours.
        </p>
        <br />
        <p>
          <i>
            Nous nous engageons résolument à observer rigoureusement les
            dispositions du RGPD en matière de protection des données, et nous
            nous assurons ainsi de n'utiliser votre adresse électronique que
            dans le cadre des échanges liés au sujet principal du site.
          </i>
        </p>
      </section>
      ...
      <section className="contact-section">
        ...
        <p>
          ...
          <br />
          Précisez quel animal n'a pas encore été découvert dans notre base de
          données !
        </p>
      ...
      <section className="contact-section">
        <h2>Un bug ?</h2>
        <p>
          Vous avez identifié une fonctionnalité qui ne semble pas ou plus
      ...
      <section className="contact-section">
        ...
        <p>
          Vous voulez nous accompagner dans la conception et l'amélioration de
          ce site ?
          <br />
          Faites-le nous savoir !
          <br />
          Que vous soyez développeurs, paléontologues amateurs ou
          professionnels, ou n'importe qui d'autre, envoyez un mail ! <br />
        </p>
        ...
        <span>
          ATTENTION: <br /> En voulant rejoindre notre équipe, vous devez être
          conscients que ce projet est <b>complètement bénévole</b>. Il s'agit
          là d'un loisir dans le simple but de rendre ce site attractif et utile
          tout en s'amusant et en partageant humblement notre savoir.
        </span>
        <span>
          Si vous êtes <b>développeurs</b> et que vous voulez faire partie de
          l'aventure, sachez que certaines fonctionnalités sont en cours de
          réflexion et n'attendent que vous. Nous prenons en compte toutes les
          suggestions et nous souhaitons intégrer le plus d'améliorations et
